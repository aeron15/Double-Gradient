...
filename=['Figure_2C_mig1_delete_heatmap_decision_front'];
...
i = 2;
[E_area{i},E_prec{i},E_mean{i}] = Plates2matBFP(plates,data,plates_hists,d,map,th_const,off_peak);
...
set(gca,'xtick',[1 3 5:2:25]+0.5,'xticklabel',['No', mat2cell(-8:2:2)]);
set(gca,'ytick',[1 3 5:2:22]+0.5,'yticklabel',['No', mat2cell(-6:2:0)]);
title('Counts \it{gal80\Delta}')

colorbar 
colormap(jet)
% caxis([0, 1])
figure(7);axis square
Set_fig_RE(figure(7),17,12,12)
